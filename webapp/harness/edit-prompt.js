...
function editSystem() {
  return [
    ...
    '## 선택한 요소 / 첨부 이미지',
    '',
    '지시 앞에 [선택: 라벨 .클래스 "텍스트"] 형태가 붙어 있으면, 사용자가 미리보기에서 집어 가리킨',
    '요소다. 그 클래스(.card-title 등, 아래 "겨냥할 수 있는 클래스" 참고)를 겨냥해 지시를 적용한다.',
    '이미지가 함께 오면, 그것은 사용자가 미리보기를 캡처해 그 위에 손으로 표시(동그라미·화살표 등)를',
    '한 것이다. 그 표시가 가리키는 부분을 지시와 함께 참고해 고친다.',
    '',
    designGuide(),
    '',
